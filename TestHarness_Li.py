...
def tests_to_run(forwarder):
    from tests import BasicTest, RandomDropTest, DoubleAllPackets, ReverseOrderTest, TestEverything, SackRandomDropTest, SackDoubleAllPackets, SackReverseOrderTest, SackTestEverything
    
    #BasicTest.BasicTest(forwarder, "Test_Text_1Packet.txt")     #test that we send an end packet even if all data fits into the first packet
    #BasicTest.BasicTest(forwarder, "Test_Text_2Packets.txt")    #test that the code works for sending a total of 2 packets.
    #BasicTest.BasicTest(forwarder, "Test_Text_5Packets.txt")    #test that the code works for sending a total of 5 packets.
    #BasicTest.BasicTest(forwarder, "Test_Text_6Packets.txt")    #test that the code works for sending a total of 6 packets.
    #BasicTest.BasicTest(forwarder, "Test_Text_10Packets.txt")    #test that the code works for sending a total of 10 packets.
    #BasicTest.BasicTest(forwarder, "Test_Text_30Packets.txt")

    #ReverseOrderTest.ReverseOrderTest(forwarder, "Test_Text_1Packet.txt")     #test that we send an end packet even if all data fits into the first packet
    #ReverseOrderTest.ReverseOrderTest(forwarder, "Test_Text_2Packets.txt")    #test that the code works for sending a total of 2 packets.
    #ReverseOrderTest.ReverseOrderTest(forwarder, "Test_Text_5Packets.txt")    #test that the code works for sending a total of 5 packets.
    #ReverseOrderTest.ReverseOrderTest(forwarder, "Test_Text_6Packets.txt")    #test that the code works for sending a total of 6 packets.
    #ReverseOrderTest.ReverseOrderTest(forwarder, "Test_Text_10Packets.txt")    #test that the code works for sending a total of 10 packets.
    #ReverseOrderTest.ReverseOrderTest(forwarder, "Test_Text_30Packets.txt")

    #DoubleAllPackets.DoubleAllPackets(forwarder, "Test_Text_1Packet.txt")     #test that we send an end packet even if all data fits into the first packet
    #DoubleAllPackets.DoubleAllPackets(forwarder, "Test_Text_2Packets.txt")    #test that the code works for sending a total of 2 packets.
    #DoubleAllPackets.DoubleAllPackets(forwarder, "Test_Text_5Packets.txt")    #test that the code works for sending a total of 5 packets.
    #DoubleAllPackets.DoubleAllPackets(forwarder, "Test_Text_6Packets.txt")    #test that the code works for sending a total of 6 packets.
    #DoubleAllPackets.DoubleAllPackets(forwarder, "Test_Text_10Packets.txt")    #test that the code works for sending a total of 10 packets.
    #DoubleAllPackets.DoubleAllPackets(forwarder, "Test_Text_30Packets.txt")

    #RandomDropTest.RandomDropTest(forwarder, "Test_Text_1Packet.txt")
    #RandomDropTest.RandomDropTest(forwarder, "Test_Text_2Packets.txt")
    #RandomDropTest.RandomDropTest(forwarder, "Test_Text_5Packets.txt")
    #RandomDropTest.RandomDropTest(forwarder, "Test_Text_6Packets.txt")
    #RandomDropTest.RandomDropTest(forwarder, "Test_Text_10Packets.txt")
    #RandomDropTest.RandomDropTest(forwarder, "Test_Text_30Packets.txt")

    #TestEverything.TestEverything(forwarder, "Test_Text_1Packet.txt")
    #TestEverything.TestEverything(forwarder, "Test_Text_2Packets.txt")
    #TestEverything.TestEverything(forwarder, "Test_Text_5Packets.txt")
    #TestEverything.TestEverything(forwarder, "Test_Text_6Packets.txt")
    #TestEverything.TestEverything(forwarder, "Test_Text_10Packets.txt")
    #TestEverything.TestEverything(forwarder, "Test_Text_30Packets.txt")

    #SackReverseOrderTest.SackReverseOrderTest(forwarder, "Test_Text_1Packet.txt")     #test that we send an end packet even if all data fits into the first packet
    #SackReverseOrderTest.SackReverseOrderTest(forwarder, "Test_Text_2Packets.txt")    #test that the code works for sending a total of 2 packets.
    #SackReverseOrderTest.SackReverseOrderTest(forwarder, "Test_Text_5Packets.txt")    #test that the code works for sending a total of 5 packets.
    #SackReverseOrderTest.SackReverseOrderTest(forwarder, "Test_Text_6Packets.txt")    #test that the code works for sending a total of 6 packets.
    #SackReverseOrderTest.SackReverseOrderTest(forwarder, "Test_Text_10Packets.txt")    #test that the code works for sending a total of 10 packets.
    #SackReverseOrderTest.SackReverseOrderTest(forwarder, "Test_Text_30Packets.txt")

    #SackDoubleAllPackets.SackDoubleAllPackets(forwarder, "Test_Text_1Packet.txt")     #test that we send an end packet even if all data fits into the first packet
    #SackDoubleAllPackets.SackDoubleAllPackets(forwarder, "Test_Text_2Packets.txt")    #test that the code works for sending a total of 2 packets.
    #SackDoubleAllPackets.SackDoubleAllPackets(forwarder, "Test_Text_5Packets.txt")    #test that the code works for sending a total of 5 packets.
    #SackDoubleAllPackets.SackDoubleAllPackets(forwarder, "Test_Text_6Packets.txt")    #test that the code works for sending a total of 6 packets.
    #SackDoubleAllPackets.SackDoubleAllPackets(forwarder, "Test_Text_10Packets.txt")    #test that the code works for sending a total of 10 packets.
    #SackDoubleAllPackets.SackDoubleAllPackets(forwarder, "Test_Text_30Packets.txt")

    #SackRandomDropTest.SackRandomDropTest(forwarder, "Test_Text_1Packet.txt")
    #SackRandomDropTest.SackRandomDropTest(forwarder, "Test_Text_2Packets.txt")
    #SackRandomDropTest.SackRandomDropTest(forwarder, "Test_Text_5Packets.txt")
    #SackRandomDropTest.SackRandomDropTest(forwarder, "Test_Text_6Packets.txt")
    #SackRandomDropTest.SackRandomDropTest(forwarder, "Test_Text_10Packets.txt")
    #SackRandomDropTest.SackRandomDropTest(forwarder, "Test_Text_30Packets.txt")

    SackTestEverything.SackTestEverything(forwarder, "test")
    SackTestEverything.SackTestEverything(forwarder, "test")
    SackTestEverything.SackTestEverything(forwarder, "test")
    SackTestEverything.SackTestEverything(forwarder, "test")
    SackTestEverything.SackTestEverything(forwarder, "test")
